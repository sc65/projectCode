...
close all; clearvars;
%%
masterFolder = '/Volumes/sapnaDrive2/200210_nodalWNT';
nWells = 2;
wellNames = {'NodalKObCatRFP', 'Control'};
nColoniesPerWell = [10 10];% number of colonies per well
nImagesPerColonyX = 2; nImagesPerColonyY = 2; % number of images per colony in the X and Y direction
%%
rawDataFile1 = 'nodalWnt_f0000_w0000_z0000.tif';
...
meta.channelNames = {'DAPI', 'T', 'betaCatenin', 'SMAD2' };
meta.channelLabel = {'nuclear', 'nuclear', 'nonMembrane', 'nuclear'};%[spots for RNA, nonMembrane for betacatenin]
...
for ii = 1:nWells
    ...
    for jj = 1:nColoniesPerWell(ii)
        ...
        figure; imshowpair(smoothMask, finalImage(:,:,dapiChannel));
